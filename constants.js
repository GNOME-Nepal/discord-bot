/**
            ...
            const RANDOM_MEME = 'https://some-meme-api.com/random';
            ...
            const createEmbed = (contributor, index, totalContributors, color) => new EmbedBuilder()
                .setColor(color)
            ...
            const calculateLatencies = (interaction) => {
                ...
                return {
                    shardLatency: interaction.client.ws.shards.reduce((acc, shard) => acc + shard.ping, 0) / interaction.client.ws.shards.size,
