...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('adminhelp')
    .setDescription(
      'Displays a list of available admin commands and their descriptions.',
    ),
  async execute(interaction) {
    const embed = new EmbedBuilder()
      ...
      .addFields(
        {
          name: '/purge <amount>',
          value: 'Delete a specified number of messages from a channel.',
        },
        {
        ...
        {
          name: '/gatelog',
          value: 'Logs user join and leave events in a specific channel.',
        },
      )
      .setFooter({
